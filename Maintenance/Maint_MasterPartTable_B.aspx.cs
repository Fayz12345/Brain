...
{
    public partial class Maint_MasterPartTable_B : System.Web.UI.Page
    {
        ...
        void MainGridPN_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                //ImageButton bEditPrice = (ImageButton)e.Row.FindControl("imgEditPrice");
                ...
                //if (bEditPrice != null) { bEditPrice.CommandArgument = "-1"; }
                ...
                if (mpl != null)
                {
                    ...
                    //if (bEditPrice != null) { bEditPrice.CommandArgument = mpl.MasterPartsLinkTableID.ToString(); }
                ...
                if (btnOpen.ID.ToUpper() == "IMGVIEWIFSLOCATIONS")
                {
                    ...
                    using (clsLinqDataContext ctx = mpm.GetDataContext(User.Identity.Name))
                    {
                        ...
                        var pt = from d in ctx.MasterPartsTableIFSLocationStorages
                                 where d.MasterPartsLinkTableID == ID
                ...
                if (btnOpen.ID.ToUpper() == "IMGEDITDEMOGRAPHICS")
                {
                    ...
                    using (clsLinqDataContext ctx = mpm.GetDataContext(User.Identity.Name))
                    {
                        ...
                        if (pt != null)
                        {
                            ...
                            //txtQTY.Text = pt.Quantity.ToString();
