<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Maint_MasterPartsClassType.aspx.cs" Inherits="BW_WebApp.Maintenance.Maint_MasterPartsClassType" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="pnlMainView" runat="server">
                ...
                <h1><asp:Label ID="lblRecordTitle" runat="server" Text="Maintenance Part Class Type" /></h1>
                ...
                <asp:Panel ID="pnlMainGrid" CssClass="overflow mb-3" runat="server">
                    <asp:GridView ID="MainGrid" CssClass="table table-striped table-nonfluid" runat="server" AutoGenerateSelectButton="True"
                        DataKeyNames="MasterPartsClassTypeID" AutoGenerateColumns="False">
                        <Columns>
                            <asp:BoundField DataField="MasterPartsClassTypeID" HeaderText="ID" ReadOnly="True" Visible="false" />
