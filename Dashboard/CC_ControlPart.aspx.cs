...
namespace BW_WebApp
{
    public partial class CC_ControlPart : System.Web.UI.Page
    {
        ...
        private void UpdateTemplateGridInactive()
        {
            ...
            string QueryString = "";
            SetMainMessage("");
            CycleCountPartManager im = new CycleCountPartManager(User.Identity.Name);
        ...
        void grdTemplateHeadersInactive_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName != "Page")
            {
                ...
                if (btnOpen.ID.ToUpper() == "IMGACTIVATE")
                {
                    ...
                    CycleCountPartManager ccm = new CycleCountPartManager(User.Identity.Name);
        ...
        void grdTemplateHeadersInactive_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                vwGetCCTemplateHeaderPart data = (vwGetCCTemplateHeaderPart)e.Row.DataItem;
                ...
                if (data != null)
                {
                    if (bInvalidate != null) { bInvalidate.CommandArgument = data.CycleInventoryCountTemplateHeaderPartsID.ToString(); }
                    if (bDownload != null) { bDownload.CommandArgument = data.CycleInventoryCountTemplateHeaderPartsID.ToString(); }
                }
            }
        }
        ...
        void grdTemplateHeaders_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName != "Page")
            {
                ...
                #endregion
                #region Download
                if (btnOpen.ID.ToUpper() == "IMGDOWNLOADPARTTEMPLATESUMMARY")
                {
                    string Message = "";
                    decimal ID = -1;
                    if (decimal.TryParse(btnOpen.CommandArgument, out ID) == false)
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "Saved", "PrintReport('CCPARTTEMPLATESUMMARY','" + btnOpen.CommandArgument + "');", true);
                }
                if (btnOpen.ID.ToUpper() == "IMGDOWNLOADPARTTEMPLATESUMMARYDETAIL")
                {
                    string Message = "";
                    decimal ID = -1;
                    if (decimal.TryParse(btnOpen.CommandArgument, out ID) == false)
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "Saved", "PrintReport('CCPARTTEMPLATESUMMARYDETAIL','" + btnOpen.CommandArgument + "');", true);
                }

                if (btnOpen.ID.ToUpper() == "IMGDOWNLOADPARTTEMPLATEDETAIL")
                {
                    string Message = "";
                    decimal ID = -1;
                    if (decimal.TryParse(btnOpen.CommandArgument, out ID) == false)
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "Saved", "PrintReport('CCPARTTEMPLATEDETAIL','" + btnOpen.CommandArgument + "');", true);
                }
        ...
        void grdTemplateHeaders_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    if (bInvalidate != null) { bInvalidate.CommandArgument = data.CycleInventoryCountTemplateHeaderPartsID.ToString(); }
                    if (bGenerateRunCycle != null) { bGenerateRunCycle.CommandArgument = data.CycleInventoryCountTemplateHeaderPartsID.ToString(); }
                    if (bDownload != null) { bDownload.CommandArgument = data.CycleInventoryCountTemplateHeaderPartsID.ToString(); }
                    if (bDownLoadTemplateSummaryDetail != null) { bDownLoadTemplateSummaryDetail.CommandArgument = data.CycleInventoryCountTemplateHeaderPartsID.ToString(); }
                    if (bDownLoadTemplateDetail != null) { bDownLoadTemplateDetail.CommandArgument = data.CycleInventoryCountTemplateHeaderPartsID.ToString(); }
                    if (bImageEdit != null) { bImageEdit.CommandArgument = data.CycleInventoryCountTemplateHeaderPartsID.ToString(); bImageEdit.CommandName = data.Name; }
        ...
        void btnAddTemplate_Click(object sender, EventArgs e)
        {
            ...
            string PartsList = "";
            PartsList = ph.Parse(PasteDeliminator, txtPasteParse);
            ...
            ID = ccm.AddTemplate(ID, drpTemplateStatus.SelectedItem.Value, Name, Note, ClientLocationID, IFSSite, txtFromLocation.Text, PartsList, ref Message);
        ...
        private void UpdateTemplateEditPage()
        {
            ...
            CycleCountPartManager ccm = new CycleCountPartManager(User.Identity.Name);
            CycleInventoryCountTemplateHeaderPart Data = ccm.GetTemplate(txtTemplateName.Text);
            drpMoveIFSSite.SelectedIndex = 0;
            txtPasteParse.Text = "";
            ...
            if (Data != null)
            {
                PasteDeliminator.SelectedIndex = 1;
                ...
                _ListItem = drpLocationList.Items.FindByValue(Data.ClientLocationID.ToString());
                if (_ListItem == null) { drpLocationList.SelectedIndex = 0; }
                else { drpLocationList.SelectedIndex = drpLocationList.Items.IndexOf(_ListItem); }

                txtFromLocation.Text = Data.IFSLocation;
                txtPasteParse.Text = Data.PartNumber;
            }
        }
        ...
        private void ClearTemplateEditPage()
        {
            ...
            txtFromLocation.Text = "";
            txtPasteParse.Text = "";
            PasteDeliminator.SelectedIndex = 0;
            drpMoveIFSSite.SelectedIndex = 1;
            drpLocationList.SelectedIndex = 0;
        }
        #endregion
        #endregion
        ...
        private void UpdategrdRuns()
        {
            ...
            CycleCountPartManager im = new CycleCountPartManager(User.Identity.Name);
            grdRunsNew.DataSource = im.GridDataRun(TabRuns.ActiveTab.HeaderText, ref QueryString).OrderBy(x => x.CycleInventoryCountHeaderPartsID);
            grdRunsNew.DataBind();
            hdnReportThisData.Value = QueryString;
            #region
            ...
            //    //string QueryString = "";
            //    decimal ID = -1;
            //    if (decimal.TryParse(hdnCycleInventoryCountHeaderPartsID.Value, out ID) == false) { ID = -1; }
        ...
        void grdRunsNew_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName != "Page")
            {
                ...
                //        return;
                //    }
                //    hdnCycleInventoryCountHeaderPartsID.Value = btnOpen.CommandArgument;
        ...
        void grdRunsNew_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                vwGetCCRunHeaderPart data = (vwGetCCRunHeaderPart)e.Row.DataItem;
                ...
                if (data != null)
                {
                    if (bActivate != null) { bActivate.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString(); bActivate.CommandName = "Run:" + data.CycleInventoryCountHeaderPartsID.ToString() + " Name:" + data.Name + "(" + data.Status + ")"; }
                    if (bInActivate != null) { bInActivate.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString(); bInActivate.CommandName = "Run:" + data.CycleInventoryCountHeaderPartsID.ToString() + " Name:" + data.Name + "(" + data.Status + ")"; }
                    if (bCLosedActivate != null) { bCLosedActivate.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString(); bCLosedActivate.CommandName = "Run:" + data.CycleInventoryCountHeaderPartsID.ToString() + " Name:" + data.Name + "(" + data.Status + ")"; }
                    if (bDownload != null) { bDownload.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString(); bDownload.CommandName = "Run:" + data.CycleInventoryCountHeaderPartsID.ToString() + " Name:" + data.Name + "(" + data.Status + ")"; }
                    if (bDownload2 != null) { bDownload2.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString(); bDownload2.CommandName = "Run:" + data.CycleInventoryCountHeaderPartsID.ToString() + " Name:" + data.Name + "(" + data.Status + ")"; }
                    if (bDownload3 != null) { bDownload3.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString(); bDownload3.CommandName = "Run:" + data.CycleInventoryCountHeaderPartsID.ToString() + " Name:" + data.Name + "(" + data.Status + ")"; }

                    if (bimgIFSReady != null) { bimgIFSReady.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString(); bimgIFSReady.CommandName = "Run:" + data.CycleInventoryCountHeaderPartsID.ToString() + " Name:" + data.Name + "(" + data.Status + ")"; }
                    //if (bDownloadDetail != null) { bDownloadDetail.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString(); bDownloadDetail.CommandName = "Run:" + data.CycleInventoryCountHeaderPartsID.ToString() + " Name:" + data.Name + "(" + data.Status + ")"; }


                    if (bOPenBatchList != null) { bOPenBatchList.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString(); bOPenBatchList.CommandName = "Run:" + data.CycleInventoryCountHeaderPartsID.ToString() + " Name:" + data.Name + "(" + data.Status + ")"; }
                    if (bHold != null) { bHold.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString(); bHold.CommandName = "Run:" + data.CycleInventoryCountHeaderPartsID.ToString() + " Name:" + data.Name + "(" + data.Status + ")"; }
                    if (bNew != null) { bNew.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString(); bNew.CommandName = "Run:" + data.CycleInventoryCountHeaderPartsID.ToString() + " Name:" + data.Name + "(" + data.Status + ")"; }
                    //if (bEdit != null) { bEdit.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString(); bEdit.CommandName = "Run:" + data.CycleInventoryCountHeaderPartsID.ToString() + " Name:" + data.Name + "(" + data.Status + ")"; }
                }
        ...
        private void UpdateSpreadGridData()
        {
            if (grdRunsNew.SelectedIndex >= 0)
            {
                ...
                if (grdRunsNew.SelectedDataKey != null && decimal.TryParse(grdRunsNew.SelectedDataKey.Value.ToString(), out ID) == true)
                {
                    ...
                    CycleCountPartManager im = new CycleCountPartManager(User.Identity.Name);
                    //gvRunSpread.DataSource = im.BatchGridData(ID, TabBatches.ActiveTab.HeaderText, ref QueryString).OrderBy(x => x.IFSLocation);
                    gvRunSpread.DataSource = im.BatchGridData(ID, ref QueryString).OrderBy(x => x.IFSLocation).ThenBy(x => x.IFSSite).ThenBy(x => x.IFSProject).ThenBy(x => x.PartNumber);
                    gvRunSpread.DataBind();
                    lblSpreadQuerry.Text = QueryString;
                    //UpdategrdSpread();
                }
        ...
        void gvRunSpread_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                vwGetCCRunHeaderBatchesPart data = (vwGetCCRunHeaderBatchesPart)e.Row.DataItem;
                ...
                if (data != null)
                {
                    if (b1 != null) { b1.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString() + "," + data.IFSSite + "," + data.IFSProject + "," + data.PartNumber + "," + data.IFSLocation; }
                    if (b2 != null) { b2.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString() + "," + data.IFSSite + "," + data.IFSProject + "," + data.PartNumber + "," + data.IFSLocation; }
                    if (b3 != null) { b3.CommandArgument = data.CycleInventoryCountHeaderPartsID.ToString() + "," + data.IFSSite + "," + data.IFSProject + "," + data.PartNumber + "," + data.IFSLocation; }
                }
        ...
        void gvSpreadOther_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName != "Page")
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "Saved", "PrintReportC('PHYSICALCOUNTPARTSCC','" + btnOpen.CommandArgument + "'," + "22" + ");", true);
                }
                #endregion
                #region Open
                if (btnOpen.ID.ToUpper() == "IMGOPEN")
        ...
        void gvSpreadOther_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                vwGridCycleInventoryCountParts_B data = (vwGridCycleInventoryCountParts_B)e.Row.DataItem;
        ...
        void LoadDropdowns()
        {
            ...
            if (drpMoveIFSSite.Items.Count > 0) { drpMoveIFSSite.SelectedIndex = 0; }
