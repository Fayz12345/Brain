<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PI_Control.aspx.cs" Inherits="BW_WebApp.PI_Control" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cMC" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Label ID="Label1" runat="server" Text="Device Physical Inventory Dashboard" Font-Bold="True" Font-Size="X-Large" ></asp:Label>
            <br /><br />
            <asp:Table ID="Table1" runat="server">
                ...
                Scan Begin/End Date
                    ...
                    <asp:TableCell VerticalAlign="Top" Wrap="False">
                        <syncfusion:DropDownCalendarControl ID="BeginDate" runat="server" CustomFormat="MM/dd/yyyy HH:mm" Format="CustomString">
...
--%>
                    ...
                    <%--    <asp:TextBox ID="txtEndDate" runat="server"></asp:TextBox>
                        ...
                        <syncfusion:DropDownCalendarControl ID="EndDate" runat="server" CustomFormat="MM/dd/yyyy hh:mm:ss" Format="CustomString">
                        </syncfusion:DropDownCalendarControl>
            ...
            <asp:TabContainer ID="TabContainerListName" runat="server" CssClass="tab-container">
...
<%--                                    <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
    ...
    <script type="text/javascript">
        ...
        function PrintTabTimeReport(Tab, StartTime, EndTime) {
            //            var xBatch = Batch();
            ...
            var xDataList = {};
            xDataList["RPT"] = "PHYSICALTABTIMECOUNT";
            xDataList["KEY"] = Tab;
            xDataList["BEGIN"] = StartTime;
            xDataList["END"] = EndTime;
...
//            var xBatch = Batch();
        ...
        function PrintReportSummary(xBatch) {
            //            var xBatch = Batch();
            if (xBatch.length == 0) {
                alert('You must supply a batch');
                return;
