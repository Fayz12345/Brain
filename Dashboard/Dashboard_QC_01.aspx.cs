...
namespace BW_WebApp
{
    public partial class Dashboard_QC_01 : System.Web.UI.Page
    {
        ...
        {
            if (MainTab.ActiveTab.HeaderText == "QC 01")
            {
                LoadRepair01();
            }
        }
        ...
        private void LoadRepair01()
        {
            ...
            grdTabRepair01.DataSource = ms.Get_QC01DataGridValuesFiltered(txtBeginDate.Text, txtWorkDaysToReport.Text, txtRoleFilter.Text);
