...
namespace BW_WebApp
{
    public partial class Dashboard_Dealer_01 : System.Web.UI.Page
    {
        clsLog log;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                wndUnitSummary.Modal = true;
                wndUnitSummary.RightToLeft = RightToLeft.No;
                //wndUnitSummary.BackColor = Color.FromName("Red");
                wndUnitSummary.Height = 730;
                wndUnitSummary.Width = 720;
                wndUnitSummary.ResizeMode = WindowResizeModeType.FreeStyle;

                wndGetPIN.Modal = true;
                wndGetPIN.RightToLeft = RightToLeft.No;
                //wndUnitSummary.BackColor = Color.FromName("Red");
                wndGetPIN.Height = 200;
                wndGetPIN.Width = 300;
                wndGetPIN.ResizeMode = WindowResizeModeType.FreeStyle;
