...
namespace BW_WebApp
{
    public partial class BucketBoard : System.Web.UI.Page
    {
        ...
        void grdStatsTodayDaily_PreRender(object sender, EventArgs e)
        {
        ...
        private void LoadStats()
        {
            ...
            //StatisticalBucketManager ms = new StatisticalBucketManager(User.Identity.Name);

            //string scmd = "GetMasterStatistical_SummarizedDailyBucketData_02 " + "";
            //grdStatsTodayDaily.DataSource = ms.GetDailySpread(ConnectionString, scmd, ClientID, ProjectName, ClientKey, RMANumber,
            ...
            //                                                    sSKU, ShowGraveYard, GroupProcess, UserName);
            //grdStatsTodayDaily.DataBind();
            ////if (grdStatsTodayDaily.Columns.Count > 5)
            ////{
            ////    grdStatsTodayDaily.Columns[0].Visible = false;
            ////    grdStatsTodayDaily.Columns[1].Visible = false;
            ////    grdStatsTodayDaily.Columns[2].Visible = false;
            ////    grdStatsTodayDaily.Columns[3].Visible = false;
            ////    grdStatsTodayDaily.Columns[4].Visible = false;
            ////}
