...
{
    public partial class Maint_Question : System.Web.UI.Page
    {
        clsLog log;
        ...
        protected void UpdateMainGrid()
        {
            ...
            var QData = (from x in qm.GetQuestionsFieldSpecificThisProject(ProjectID).OrderBy(y => y.Name).ThenBy(y => y.Sequence)
