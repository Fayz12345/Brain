<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Maint_LabDestinationBinLookup.aspx.cs" Inherits="BW_WebApp.Maintenance.Maint_LabDestinationBinLookup" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="pnlMainView" runat="server">
                ...
                <h1><asp:Label ID="lblRecordTitle" runat="server" Text="Lab Destination Bin Lookup" /></h1>
                ...
                <asp:GridView ID="MainGrid" CssClass="table table-nonfluid" runat="server" AutoGenerateSelectButton="True" DataKeyNames="OptionID" AutoGenerateColumns="False">
                    <Columns>
                        <asp:BoundField DataField="OptionID" HeaderText="ID" ReadOnly="True" Visible="false" />
            ...
            <asp:Panel ID="pnlEdit" runat="server">
                <h1>Edit Lab Destination Bin</h1>
                <asp:Label ID="lblDestination" runat="server" Text="" />
                <asp:TextBox ID="EditBin" CssClass="w-md-50" runat="server" />
