...
<%--                     <asp:Label ID="Label1_02" runat="server" Text="ClientID" Font-Size="X-Small"></asp:Label><br />
    ...
    <asp:Panel ID="RegularBagTag_03SKU" runat="server" Height="86mm">
     ...
     <%-- %>UK Bag Tag 1--%>
        ...
        <asp:Panel ID="RegularBagTag_01UK" runat="server" Height="86mm">
        <asp:Table ID="Table6" runat="server" CellPadding="0" CellSpacing="0" Width="62mm" style="font-family: Helvetica">
            <asp:TableRow ID="TableRow25">
                <asp:TableCell BorderColor="black" BorderWidth="2px" Style="text-align:center; padding:5px;">
                    <asp:Label Font-Size="XX-Large" Font-Bold="True" ID="lblGrade_UK_01" runat="server" Text="A" ></asp:Label>
                    <br />
                    <asp:Label ID="Label13" runat="server" Text="GRADE" ></asp:Label>
                </asp:TableCell>
                <asp:TableCell Style="Padding-left:10px;" >
                    <asp:Label Font-Size="Large" Font-Bold="True" ID="lblMake_UK_01" runat="server" Text="Make" ></asp:Label>
                    <br />
                    <asp:Label ID="lblModel_UK_01" runat="server" Text="Model" ></asp:Label>
                    <br />
                    <asp:Label ID="lblMemory_UK_01" runat="server" Text="Memory" ></asp:Label>
                    /
                    <asp:Label ID="lblColour_UK_01" runat="server" Text="Colour" ></asp:Label>
            ...
            <asp:TableRow ID="TableRow19">
                ...
                <br />
                    <cc1:LinearBarcode ID="bcBagtag_UK_01" runat="server" SymbologyID="Code128" ShowText="True"
                        ImageAutoDelete="True" BarHeightCM="1" LeftMarginCM="0.000" TopMarginCM="0"
                        ImageResolution="300" DataToEncode="" CheckCharacter="False" CheckCharacterInText="False"
                        Height=".75in" ImageType="JPEG" XDimensionCM="0.0400" />
                </asp:TableCell>
            </asp:TableRow>
      <%--      <asp:TableRow ID="RowLabel1_03SKU">
                <asp:TableCell ColumnSpan="2">
            ...
            <asp:TableRow ID="TableRow20">
                <asp:TableCell ColumnSpan="2" BorderColor="black" BorderWidth="2px" Style="text-align:center; padding:5px;">
                    <asp:Label ID="lblDefects_1_UK_01" runat="server" Text="Defect 1" ></asp:Label><br />
                    <asp:Label ID="lblDefects_2_UK_01" runat="server" Text="Defect 2" ></asp:Label><br />
                    <asp:Label ID="lblDefects_3_UK_01" runat="server" Text="Defect 3" ></asp:Label><br /><br />
                    <asp:Label ID="lblData_Wiped_UK_01" Font-Bold="True" runat="server" Text="Data Wiped" ></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="TableRow23">
                <asp:TableCell ColumnSpan="2" Style="text-align:center; padding:5px;">
                    <asp:Label Font-Size="Large" Font-Bold="True" ID="lblProject_Tag_UK_01" runat="server" Text="ProjectTag"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
        ...
        <asp:Panel ID="RegularBagTag_02UK" runat="server" Height="62mm">
        <asp:Table ID="Table8" runat="server" CellPadding="0" CellSpacing="0" Width="89mm" style="font-family: Helvetica">
            <asp:TableRow ID="TableRow21">
                <asp:TableCell BorderColor="black" BorderWidth="2px" Style="text-align:center; padding:5px;">
                    <asp:Label Font-Size="XX-Large" Font-Bold="True" ID="Label7" runat="server" Text="A" ></asp:Label>
                    <br />
                    <asp:Label ID="lblGrade_UK_02" Font-Bold="True" runat="server" Text="GRADE" ></asp:Label>
                </asp:TableCell>
                <asp:TableCell Style="Padding-left:10px;" >
                    <asp:Label Font-Size="X-Large" Font-Bold="True" ID="lblMake_UK_02" runat="server" Text="Make" ></asp:Label>
                    <br />
                    <asp:Label ID="lblModel_UK_02" runat="server" Text="Model" ></asp:Label>
                    <br />
                    <asp:Label ID="lblMemory_UK_02" runat="server" Text="Memory" ></asp:Label>
                    /
                    <asp:Label ID="lblColour_UK_02" runat="server" Text="Colour" ></asp:Label>
                    <asp:Label ID="lblModel_Notes_UK_02" runat="server" Text="Model_Notes" ></asp:Label>
      ...
      <%--      <asp:TableRow ID="RowLabel1_03SKU">
            ...
            <asp:TableRow ID="TableRow24">
             
                <asp:TableCell>
                    <asp:Label ID="Label8" runat="server" Font-Bold="True" Text="Defects" >Defects: </asp:Label><br />
                    <asp:Label ID="lblDefects_1_UK_02" runat="server" Text="Defect 1" ></asp:Label><br />
                    <asp:Label ID="lblDefects_2_UK_02" runat="server" Text="Defect 2" ></asp:Label><br />
                    <asp:Label ID="lblDefects_3_UK_02" runat="server" Text="Defect 3" ></asp:Label><br /><br />
                    <asp:Label ID="lblData_Wiped_UK_02" Font-Bold="True" runat="server" Text="Data Wiped" ></asp:Label><br />
                    <asp:Label ID="lblAnalysis_UK_02" Font-Bold="True" runat="server" Text="Analysis" ></asp:Label>
                </asp:TableCell>

                <asp:TableCell>
                    <br />
                    <asp:Label ID="Label10" runat="server" Font-Bold="True" Text="User" >User: </asp:Label>
                    <asp:Label ID="lblLastUpdateUser_UK_02" Font-Bold="True" runat="server" Text="User" ></asp:Label><br />
                    <asp:Label ID="Label12" runat="server" Font-Bold="True" Text="Project Tag" >Project Tag: </asp:Label>
                    <asp:Label ID="lblProject_Tag_UK_02" Font-Bold="True" runat="server" Text="ProjectTag"></asp:Label><br />
                    <asp:Label ID="Label9" runat="server" Font-Bold="True" Text="Received" >Received: </asp:Label>
                    <asp:Label ID="lblRECEIVEDATE_UK_02" Font-Bold="True" runat="server" Text="RECEIVEDATE" ></asp:Label><br />
                    <asp:Label ID="Label11" runat="server" Font-Bold="True" Text="Test" >Test: </asp:Label>
                    <asp:Label ID="lblLastUpdateDate_UK_02" Font-Bold="True" runat="server" Text="LastUpdateDate" ></asp:Label><br />
    

                 <br />
                    <cc1:LinearBarcode ID="bcBagtag_UK_02" runat="server" SymbologyID="Code128" ShowText="True"
                        ImageAutoDelete="True" BarHeightCM="1" LeftMarginCM="0.000" TopMarginCM="0"
                        ImageResolution="300" DataToEncode="" CheckCharacter="False" CheckCharacterInText="False"
                        Height=".75in" ImageType="JPEG" XDimensionCM="0.0400" />
