...
/****** Object:  UserDefinedFunction [dbo].[GetSKU]    Script Date: 08/09/2017 11:52:23 ******/
SET ANSI_NULLS ON
GO
...
Return isnull(@ManufacturerABBR,'') + isnull(@ModelABBR,'') + isnull(@CarrierABBR,'') + isnull(@ColourABBR,'') + ' INVALID'
END
USE [BW_Sandbox02]
GO
/****** Object:  UserDefinedFunction [dbo].[GetSKU]    Script Date: 08/09/2017 11:52:23 ******/
