<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IFSLocationUpdate.aspx.cs" Inherits="GMPI_WebApp.IFSLocationUpdate" %>
                                        ...
                                        <asp:TabContainer ID="TabContainer2" runat="server">
                                            ...
                                            <asp:TabPanel ID="tabDIDMAdjOut" runat="server" HeaderText="Adj Out">
                                                <ContentTemplate>
                                                    ...
                                                    <br />
                                                    <asp:Panel ID="Panel13" runat="server" Style="overflow: auto; max-height: 360px;
                                                        min-height: 360px; max-width: 415px;" HorizontalAlign="Left" Width="100%">
...
<%--                                                            <asp:TableRow class="transfer_to">
                ...
                <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="Device Physical Inventory Count" Visible="False">
                    <ContentTemplate>
                                ...
                                <table id="Table3" runat="server" width="100%">
                                    <tr>
                                        <td align="left" valign="top">
                                            <h1>
                                                Device Physical Inventory Count (IFS)</h1>
                                        </td>
                                        <td align="right" valign="top">
                                            <asp:CheckBox ID="chkUpdateIMEI" runat="server" Text="Update IMEI" TextAlign="right"
                                                Enabled="False" Checked="True" />
<%--                                            <br />
                                            <asp:Button ID="btnDownloadPIC" runat="server" Text="Download" OnClientClick='PrintReport(); return false;' />--%>
                                            <br />
                                            <asp:Button ID="btnLockBatch" runat="server" Text="Lock Batch" />
...
<%--                                            <asp:Button ID="btnInvalidate" runat="server" Text="Invalidate" />
                                            <asp:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="btnInvalidate"
...
<%--                                        <td align="left" valign="bottom">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="top">
                                            <asp:DropDownList ID="drpIFSSite" runat="server">
                                            </asp:DropDownList>
                                        </td>
                                        <td align="left" valign="top">
                                            <asp:DropDownList ID="drpIFSProject" runat="server">
                                            </asp:DropDownList>
                                        </td>
                                        <td align="left" valign="top">
                                            <asp:DropDownList ID="drpIFSCondition" runat="server">
                                            </asp:DropDownList>
                                        </td>
                                        <td align="left" valign="top">
                                            <asp:Button ID="btnResetCount" runat="server" Text="Reset Counter" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" valign="top">
