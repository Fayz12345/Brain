<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dashboard_Repair_01.aspx.cs" Inherits="BW_WebApp.Dashboard_Repair_01" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cMC" runat="server">
    <h1>Dashboard - Repair</h1>
                            ...
                            <asp:Panel ID="pnlMainGrid" runat="server" Style="overflow: auto; max-height: 500px;
                                ...
                                <asp:GridView ID="grdTabRepair01" CssClass="table" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="C0_A" HeaderText="Bridge Repair" ReadOnly="True" />
                                        <asp:BoundField DataField="C0_B" HeaderText="MSC Repair handling" ReadOnly="True" />
                                        <asp:BoundField DataField="C0_C" HeaderText="Product Placement" ReadOnly="True" />
                                        <asp:BoundField DataField="C0_D" HeaderText="MSC Return" ReadOnly="True" />
                                     <%--   <asp:BoundField DataField="C1_Date" HeaderText="Period" ReadOnly="True" />
                                        ...
                                        <asp:BoundField DataField="C1_A" HeaderText="Bridge Repair" ReadOnly="True" />
                                        <asp:BoundField DataField="C1_B" HeaderText="MSC Repair handling" ReadOnly="True" />
                                        <asp:BoundField DataField="C1_C" HeaderText="Product Placement" ReadOnly="True" />
                                        ...
                                        <asp:BoundField DataField="C2_A" HeaderText="Bridge Repair" ReadOnly="True" />
                                        <asp:BoundField DataField="C2_B" HeaderText="MSC Repair handling" ReadOnly="True" />
                                        <asp:BoundField DataField="C2_C" HeaderText="Product Placement" ReadOnly="True" />--%>
