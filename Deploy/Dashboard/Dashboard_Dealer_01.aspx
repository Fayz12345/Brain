<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dashboard_Dealer_01.aspx.cs" Inherits="BW_WebApp.Dashboard_Dealer_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cMC" runat="server"> 
                                ...
                                <asp:TableCell>
                                    ...
                                    <asp:Panel ID="Panel2" runat="server" Width="100%" Height="100%" ScrollBars="Auto">
                                        <asp:GridView ID="gvDashboard" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="ServiceRequestNumber" HeaderText="Service Request #" HeaderStyle-HorizontalAlign="Left">
                   ...
                   <table id="Table6" runat="server" width="100%">
                       ...
                       <tr>
                           ...
                           <td align="left" valign="top">
                               ...
                               <asp:TextBox ID="txtServiceRequestNumber" runat="server" Enabled="False"></asp:TextBox>
                           </td>
                           <td align="right" valign="top">
                               Customer Name:
                           </td>
                       ...
                       <tr>
                           ...
                           <td align="left" valign="top" colspan="3">
                               <asp:TextBox ID="txtStoreComments" runat="server" Enabled="False" Rows="2" TextMode="MultiLine" Width="95%"></asp:TextBox>
                          </td>
                       </tr>
  ...
  <script type="text/javascript">
      ...
      function OpenClientbagTag(ReceiveDetailID) {
          ...
          var WindowToOpen = 'RPT_Submission_01.aspx';
