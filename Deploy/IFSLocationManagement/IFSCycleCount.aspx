<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IFSCycleCount.aspx.cs" Inherits="BW_WebApp.IFSCycleCount" %>
            ...
            <asp:Panel ID="pnlSpreadOther" runat="server" Style="width: auto;" HorizontalAlign="Left">
                <asp:Table ID="Table2" runat="server" Width="100%">
                    <asp:TableRow ID="TableRow4">
                        ...
                        <h1>
                            Device Cycle Count Count (IFS)</h1>
                                    </asp:TableCell>
                                </asp:TableRow>
