    ...
    public partial class Receive : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                TimeLogManager timelog = new TimeLogManager(User.Identity.Name, "");
                timelog.StartTimer();
                string[] s = Roles.GetRolesForUser(User.Identity.Name);
                Array.Sort(s);
                hdnRoleList.Value = "," + string.Join(",", s) + ",";

                //Log.LogIt("GetDetailSheetData - Finished (" + User.Identity.Name + ")");
                timelog.StopTimer();
                timelog.SaveTimeLogRoleList(-1, -1, hdnRoleList.Value);
        ...
        void SetTabs()
        {
            ...
            //TabPanelBulkProcess.Visible = false;
            chkSticky.Checked = false;
            chkSticky.Visible = false;
            TabPanelSKU.Visible = false;
            TabPanelBulkProcess.Visible = false;
        ...
        void InitializeProject(bool RunSetup)
        {
            ...
            else
            {
                ...
                if (pj != null)
                {
                    ...
                    lblCarrierLock.Text = "False";
                    if (pj.isMasterCarrierManufactuerLinked == true) { lblCarrierLock.Text = "True"; }
        ...
        void RestrictFunctions()
        {
            ...
            //if (rdm.UserRestrict.AllowSelectFunctionExecute("Work.Tab.Authorization.Bulk", ctx) == true) { TabPanelBulkProcess.Visible = true; }
            //}
        }
 ...
 TextBox t3, TextBox t10, TextBox t18, TextBox t50, bool bEnabled)
        {
            ...
            if (bEnabled == true)
            {
                ...
                if (Quest.Name == "Memory") { hdnMemoryID.Value = D1.ClientID; }
