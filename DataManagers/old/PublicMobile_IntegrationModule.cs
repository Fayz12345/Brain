...
namespace BW_IntegrationManager_PublicMobile
{
    public class IntegrationManager_PublicMobile
    {
        ...
        public string GenerateFile01(string fName)
        {
            ...
            using (clsLinqDataContext ctx = new clsLinqDataContext())
            {
                ...
                var data = from r in ctx.ReceiveDetails
                           //where r.ClientLocation.Client.CompanyName.ToUpper() == "GOLDIE GROUP"
                           where r.ClientLocation.Client.CompanyName.ToUpper() == "PUBLIC MOBILE"  && r.Version == "000"                          //"GOLDIE GROUP"
                           select r;
        ...
        //public string GenerateFile01_Stream(string fName)
        //{
        //    StringBuilder file = new StringBuilder();
        //    using (clsLinqDataContext ctx = new clsLinqDataContext())
        //    {
        ...
        //        var data = from r in ctx.ReceiveDetails
        //                   where r.ClientLocation.Client.CompanyName.ToUpper() == "PUBLIC MOBILE"                            //"GOLDIE GROUP"
        //                   select r;
        //        foreach (ReceiveDetail d in data)
        //        {
        //            file.AppendLine(CreateFile01File(d));
        //        }
        ...
        //    //Server.MapPath("~/UploadedExcel/" + strFileName + strFileType)
