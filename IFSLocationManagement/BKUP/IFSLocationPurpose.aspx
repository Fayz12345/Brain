<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IFSLocationPurpose.aspx.cs" Inherits="GMPI_WebApp.IFSLocationManagement.IFSLocationPurpose" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlMainView" runat="server">
                <asp:Panel ID="Panel3" runat="server" HorizontalAlign="Left" Width="100%">
                    ...
                    <asp:Label ID="lblRecordTitle" runat="server" Text="Maintenance MasterIFSLocation Purpose"></asp:Label>
                </asp:Panel>
                <asp:Panel ID="pnlMainGrid" runat="server" Height="2in" Width="100%" ScrollBars="Auto"
                    ...
                    <asp:GridView ID="MainGrid" runat="server" Width="100%" AutoGenerateSelectButton="True"
                        DataKeyNames="MasterIFSLocationPurposeID" AutoGenerateColumns="False" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt">
                ...
                <table>
                    <tr>
                        <td id="AddTemplateHeader" colspan="2" style="border-style: none none solid none;
                            ...
                            <h1>
                                Add MasterIFSLocation Purpose</h1>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="AddPurpose" runat="server" ></asp:TextBox><br />
                        </td>
                    </tr>
                ...
                <table>
                    <tr>
                        <td id="Td1" colspan="2" style="border-style: none none solid none; border-width: thick;
                            ...
                            <h1>
                                Edit MasterIFSLocation Purpose</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right; vertical-align: top;">
                        ...
                        <td>
                            <asp:TextBox ID="EditPurpose" runat="server" BackColor="#FFFF66"></asp:TextBox><br />
