<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IFSDevicePI.aspx.cs" Inherits="GMPI_WebApp.IFSDevicePI" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:TabContainer ID="TabContainer1" runat="server">
                <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="Device Physical Inventory Count">
                    <ContentTemplate>
...
//       }
       ...
       function SaveScanData() {
           ...
           service.LogPhysicalDeviceCount_BKUP(xLocationID
                             , xIFSConditionID
                             , xESN
                             , xBatch
                             , xIFSSite
