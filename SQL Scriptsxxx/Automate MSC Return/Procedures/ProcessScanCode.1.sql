/****** Object:  StoredProcedure [dbo].[ProcessScanCode]    Script Date: 11/21/2017 13:40:57 ******/
SET ANSI_NULLS ON
GO
...
-- Scan NextProcessStep
   ...
   if @mReturnMessage is null
      ...
      -- print substring('MSC Returnxxxxxx',1, 10)
      -- We want to see if this is a MSC Return Device.
      if substring(@mProcessSource, 1, 10) = 'MSC Return'
	     begin
