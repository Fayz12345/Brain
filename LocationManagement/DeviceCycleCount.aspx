<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeviceCycleCount.aspx.cs" Inherits="BW_WebApp.LocationManagement.DeviceCycleCount" %>
   ...
   <script type="text/javascript">
       ...
       function RecordScan() {
           ...
           if (xBatch.length == 0) {
               ...
               service.GetNewCycleCountDeviceBatch(xUserName, CycleCountID(), cycleCountName, cycleCountTypeName, xLocation, onSuccessNewBatch, onServerError);
           } else { SaveScanData(); }
       }
