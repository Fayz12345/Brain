...
namespace BW_WebApp
{
    public partial class ReceiveDetailMessageQueue : System.Web.UI.Page
    {
    ...
    public class MessageQueueData
    {
        ...
        public MessageQueueData(decimal ID, string statusOpen, string statusStop, string esn, DateTime createdate, string createuser, string message)
        {
            ReceiveDetailESNMessageID = ID;
