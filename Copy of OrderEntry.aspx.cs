...
using GMPI_WebApp.Classes;
//using ScanKey;
//using Factory_DataModel;

using GMPI_WebApp.DataManagers;
using GMPI_WebApp.BarcodeUtils;
    ...
    public partial class OrderEntry : System.Web.UI.Page
    {
        ...
        void grdTempDetail_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                GetOrderEntryList_TemplateRawData_SearchGridResult Data = ((GetOrderEntryList_TemplateRawData_SearchGridResult)e.Row.DataItem);
        ...
        void btnEmail_Details_Click(object sender, EventArgs e)
        {
            ...
            List<GetOrderEntryList_TemplateRawData_SearchGridResult> Data = GetDataSet();
            ...
            if (Data != null)
            {
                ...
                foreach (GetOrderEntryList_TemplateRawData_SearchGridResult r in Data.OrderBy(x => x.OrderDate).ThenBy(x => x.OrderNumber))
                {
                    Body.Append("<tr>");
        ...
        private List<GetOrderEntryList_TemplateRawData_SearchGridResult> GetDataSet()
        {
            string Status = "";
            ...
            return rdm.GetOrderEntryList(Status, OrderNumber, CustomerPO, WayBillNumber, ProjectTag, CompanyName, City, PostalCode, PhoneNumber, EmailAddress, OrderBeginDate, OrderEndDate);
        }
        #endregion
