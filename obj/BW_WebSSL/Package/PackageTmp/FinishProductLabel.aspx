<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinishProductLabel.aspx.cs" Inherits="BW_WebApp.FinishProductLabel" %>
...
<body onload="printIt();" style="padding-left:0; margin-left:0">
    ...
    <div>
        ...
        <asp:Panel runat="server" ID="KIT_IMM_01" Width="70mm" Height="48mm" Font-Names="Ariel" Font-Size="10pt">
            <asp:Table ID="Table16" runat="server" CellPadding="0" CellSpacing="0" Width="65mm">
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Right" VerticalAlign="Top">
                    Manufacturer:
                    </asp:TableCell>
                    <asp:TableCell Wrap="False" HorizontalAlign="Left">
                        <asp:Label ID="lblManufacturer_10" runat="server" Text="Manufacturer"></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Right" VerticalAlign="Top">
                    ...
                    <asp:TableCell Wrap="False" HorizontalAlign="Left">
                        <asp:Label ID="lblModel_10" runat="server" Text="Model"></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Right" VerticalAlign="Top">
                    ...
                    <asp:TableCell Wrap="False" HorizontalAlign="Left">
                        <asp:Label ID="lblCarrier_10" runat="server" Text="Carrier" Width="100%"></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Right" VerticalAlign="Top">
                    ...
                    <asp:TableCell Wrap="False" HorizontalAlign="Left">
                        <asp:Label ID="lblColour_10" runat="server" Text="Colour" Width="100%"></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
<%--                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Right" VerticalAlign="Top">
                    ...
                    <asp:TableCell Wrap="False" HorizontalAlign="Left">
                        <asp:Label ID="lblMemory_10" runat="server" Text="Memory" Font-Bold="True" Width="100%"
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell HorizontalAlign="Left">
                        <asp:Label ID="lblSKU_10" runat="server" Text="SKU" Width="100%"></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Right" VerticalAlign="Top">
                    ...
                    <asp:TableCell HorizontalAlign="Left">
                        <asp:Label ID="lblIMEI_10" runat="server" Text="IMEI" Width="100%"></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Center" ColumnSpan="2">
                        <cc1:LinearBarcode ID="IMEI_10" runat="server" SymbologyID="Code128" ShowText="True"
        ...
        <asp:Panel runat="server" ID="KIT_WIND" Width="70mm" Height="48mm">
            <asp:Table ID="Table12" runat="server" CellPadding="0" CellSpacing="0" Width="65mm">
                <asp:TableRow>
        ...
        <asp:Panel runat="server" ID="KIT_FWDLOG" Width="70mm" Height="98mm">
...
<%--                    <asp:TableCell HorizontalAlign="Left" VerticalAlign="Top">
        ...
        <asp:Panel runat="server" ID="FTP_WIND" Height="98mm">
            <asp:Table ID="Table14" runat="server" CellPadding="0" CellSpacing="0" Width="85mm">
                <asp:TableRow>
                    <asp:TableCell>
                    ...
                    <asp:TableCell HorizontalAlign="Right" Wrap="False">
                        <asp:Label ID="lblDescription_Wind" runat="server" Text="xxxxxxxxxxxxxxxxxxxxxxxxx" Font-Size="Small"></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="2">
                        <asp:Label ID="Label17x" runat="server" Text="____________________________________________" Font-Bold="True"></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Left" VerticalAlign="Top">
        ...
        <asp:Panel runat="server" ID="FPL_APPLE" style="padding-left:80px; margin-left:0" Height="98mm">
        ...
        <asp:Panel runat="server" ID="FPL_01" Height="98mm">
            <asp:Table ID="Table6" runat="server" CellPadding="0" CellSpacing="0" Width="85mm">
                ...
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                        <asp:Label ID="Label17" runat="server" Text="____________________________________________" Font-Bold="True"></asp:Label>
                        <br />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
        ...
        <asp:Panel runat="server" ID="FPL_02" Height="98mm">
        ...
        <asp:Panel runat="server" ID="FPL_03" Height="98mm">
...
<%--                        <asp:Label ID="lblModel_03" runat="server" Text="Model" Font-Bold="True" Width="100%"></asp:Label>
                ...
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                        <asp:Label ID="Label2" runat="server" Text="____________________________________________" Font-Bold="True"></asp:Label>
                        <br />
                    </asp:TableCell>
                </asp:TableRow>
...
<%--                <asp:TableRow>
        ...
        <asp:Panel runat="server" ID="FPL_04" Height="98mm">
...
<%--                <asp:TableRow>
                ...
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="3" HorizontalAlign="Center">
                        <asp:Label ID="Label4" runat="server" Text="____________________________________________" Font-Bold="True"></asp:Label>
                        <br /> 
                    </asp:TableCell>
                </asp:TableRow>
...
<%--                <asp:TableRow>
        ...
        <asp:Panel runat="server" ID="FPL_Staple" Height="98mm">
           <asp:Table ID="Table15" runat="server" CellPadding="0" CellSpacing="0" Width="85mm">
                ...
                <asp:TableRow>
                    <asp:TableCell Wrap="False" VerticalAlign="Top">
                        <asp:Label ID="Label23" runat="server" Text="UPC:"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ColumnSpan="2" HorizontalAlign="Left" VerticalAlign="Top">
...
<%--                <asp:TableRow>
        ...
        <asp:Panel runat="server" ID="FPL_05" Height="98mm">
        ...
        <asp:Panel runat="server" ID="FPL_BB" Height="98mm">
        ...
        <asp:Panel runat="server" ID="FPL_06" Height="98mm">
        ...
        <asp:Panel runat="server" ID="FPL_07" Height="98mm">
    ...
    <asp:Panel ID="P_OTHER" runat="server" Visible="false" Height="98mm">
