<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IFSLocationPartUpdate.aspx.cs" Inherits="BW_WebApp.IFSLocationPartUpdate" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:TabContainer ID="TabContainer1" runat="server">
                <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="Parts Inventory Distribution (IFS)">
                    <ContentTemplate>
                ...
                <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="Part Physical Inventory Count" Visible="False">
                    <ContentTemplate>
