<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IFSLocationMaster.aspx.cs" Inherits="BW_WebApp.IFSLocationManagement.IFSLocationMaster" %>
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlMainView" runat="server">
                <asp:Table ID="xxx" runat="server">
                    <asp:TableRow runat="server">
                        <asp:TableCell Wrap="False">
                            <asp:Label ID="Label1" runat="server" Text="Search Location:"></asp:Label>
                        </asp:TableCell>
                        <asp:TableCell>
                            <asp:TextBox ID="txtSEG1" runat="server" MaxLength="3" Width="75px" TabIndex="1"></asp:TextBox>
                        </asp:TableCell>
                        <asp:TableCell>
                        ...
                        <asp:TableCell>
                            <asp:TextBox ID="txtSEG2" runat="server" MaxLength="3" Width="75px" TabIndex="2"></asp:TextBox>
                        </asp:TableCell>
                        <asp:TableCell>
                        ...
                        <asp:TableCell>
                            <asp:TextBox ID="txtSEG3" runat="server" MaxLength="3" Width="75px" TabIndex="3"></asp:TextBox>
                        </asp:TableCell>
                        <asp:TableCell>
                        ...
                        <asp:TableCell>
                            <asp:TextBox ID="txtSEG4" runat="server" MaxLength="3" Width="75px" TabIndex="4"></asp:TextBox>
                        </asp:TableCell>
                        <asp:TableCell>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="grdViewParts" runat="server" Width="100%" AutoGenerateSelectButton="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IFSLocationALT" HeaderText="LocationALT" HeaderStyle-HorizontalAlign="Left">
                                            <ItemStyle HorizontalAlign="left" />
                                        </asp:BoundField>
                                    </Columns>
                                </asp:GridView>
                ...
                <asp:Panel ID="pnlMasterList" runat="server" HorizontalAlign="Left" Width="100%">
                    ...
                    <asp:Label ID="lblRecordTitle" runat="server" Text="Location Master table:"></asp:Label>
