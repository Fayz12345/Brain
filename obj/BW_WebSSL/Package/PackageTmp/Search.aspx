                                    ...
                                    <asp:Table ID="Table1" CssClass="table" runat="server">
                                        ...
                                        <asp:TableRow>
                                            ...
                                            <asp:TableCell ColumnSpan="2">
                                                <asp:TextBox runat="server" ID="txtIFSSku" ToolTip="IFS SKU"></asp:TextBox>
                                            </asp:TableCell>
                                        </asp:TableRow>
                                        <asp:TableRow>
                                            <asp:TableCell>
                                            ...
                                            <asp:TableCell ColumnSpan="2">
                                                <asp:TextBox runat="server" ID="txtIFSLocation" ToolTip="IFS Location"></asp:TextBox>
                                            </asp:TableCell>
                                        </asp:TableRow>
                                        <asp:TableRow>
                                            <asp:TableCell>
                                            ...
                                            <asp:TableCell ColumnSpan="2">
                                                <asp:TextBox runat="server" ID="txtIFSCondtion" ToolTip="IFS Condition"></asp:TextBox>
                                            </asp:TableCell>
                                        </asp:TableRow>
                                    </asp:Table>
                                </div>
