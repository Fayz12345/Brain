<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OrderEntry.aspx.cs" Inherits="BW_WebApp.OrderEntry" %>
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlmainentry" runat="server">
                <asp:TabContainer runat="server" ID="tabMain" CssClass="tab-container" ActiveTabIndex="0" AutoPostBack="True">
                    ...
                    <asp:TabPanel runat="server" ID="TabPanelInvoice" CssClass="tab-panel" Enabled="true" HeaderText="Invoice" Visible="False">
<%--                        <ContentTemplate>
                            <label>Courier:</label>
                            <asp:DropDownList ID="DropDownList1" CssClass="w-md-50" runat="server" />
                        </ContentTemplate>--%>
                    </asp:TabPanel>
                        ...
                        <Columns>
                            <asp:TemplateField ItemStyle-Wrap="False">
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="btnInvoice" CssClass="btn btn-default p-1" runat="server" ToolTip="despatch">
                                        <span class="oi oi-spreadsheet"></span>
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="btnInvoicePDF" CssClass="btn btn-default p-1" runat="server" ToolTip="despatch PDF">
                                        <span class="oi oi-document"></span>
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="btnInvoiceDetail" CssClass="btn btn-default p-1" runat="server" ToolTip="despatch Detail">
                                        <span class="oi oi-briefcase"></span>
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="btnInvoiceDetail01" CssClass="btn btn-default p-1" runat="server" ToolTip="despatch Detail B">
                                        <span class="oi oi-action-redo"></span>
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="btnInvoiceDetail02" CssClass="btn btn-default p-1" runat="server" ToolTip="despatch Detail C">
                            ...
                            <asp:BoundField DataField="RequestUser" HeaderText="Sales Person" ReadOnly="True" Visible="True" />
...
<%--
                ...
                <div class="row">
                    <div class="col-md">
                        ...
                        <div>
                            <label>
                                Terms:</label><br />
                            <asp:DropDownList ID="drpTerms" CssClass="w-md-50" runat="server">
                    ...
                    <div class="col-md">
                        ...
                        <div>
                            ...
                            <asp:TextBox ID="txtOrderNumberEdit" runat="server" MaxLength="50" Enabled="False" />
                        ...
                        <div>
                            <%--<label>
                                ...
                                <br />
                            <asp:TextBox ID="txtProjectTag" runat="server" Width="100%" Visible="false"></asp:TextBox>
                        </div>
                        <div>
                            <label>
                ...
                <asp:TabContainer runat="server" ID="TabContainer1" CssClass="tab-container" ActiveTabIndex="0"
                    AutoPostBack="False">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    ...
                                    <div>
                                        ...
                                        <asp:DropDownList ID="drpTaxRate" runat="server" ToolTip="TaxRate" AutoPostBack="false">
                                        </asp:DropDownList>
                                    </div>
                                    <div>
                                        <label>
                                        ...
                                        <%--  <asp:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server" TargetControlID="btnPanelMove" ConfirmText="Are you sure you want to Make this move?" />--%>
                ...
                <asp:Label ID="lblOrderErrorMessage" runat="server" /><br />
                    ...
                    <div class="row">
                        <div class="col-md">
                            <div>
                                <label>
                                    Note:</label>
                                <asp:TextBox ID="txtLineNote" runat="server" MaxLength="100"></asp:TextBox><br />
                            </div>
                        </div>
                    </div>
 <%--                   <div class="row">
