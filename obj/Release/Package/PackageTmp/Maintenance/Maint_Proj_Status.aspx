<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Maint_Proj_Status.aspx.cs" Inherits="BW_WebApp.Maintenance.Maint_Proj_Status" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="pnlMainView" runat="server">
                ...
                <h1><asp:Label ID="lblRecordTitle" runat="server" Text="Maintenance Project Status" /></h1>
                ...
                <asp:GridView ID="MainGrid" CssClass="table table-nonfluid" runat="server" AutoGenerateSelectButton="True" DataKeyNames="ProjectStatusID" AutoGenerateColumns="False">
                    <Columns>
                        <asp:BoundField DataField="ProjectStatusID" HeaderText="ID" ReadOnly="True" Visible="false" />
