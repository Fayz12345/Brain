<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Maint_IMEIDeviceUtility.aspx.cs" Inherits="BW_WebApp.Maintenance.Maint_IMEIDeviceUtility" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:TabContainer ID="TabContainer1" CssClass="tab-container" runat="server">
                <asp:TabPanel ID="TabPanel1" CssClass="tab-panel" runat="server" HeaderText="Device Inventory Distribution (DID)">
                    <ContentTemplate>

                        <asp:Label ID="lblMessage" runat="server" Text=""></asp:Label>
                        <h1>IMEI Device Utility screen</h1>

                        <div class="row">

                        	<div class="col-md">
                                <h3>From:</h3>
                                <asp:TabContainer CssClass="tab-container" ID="TabContainer3" runat="server">
                                    <asp:TabPanel ID="TabDIDMFromESN" CssClass="tab-panel" runat="server" HeaderText="ESN" ToolTip="ESN">
                                        <ContentTemplate>
                                            <h5>Select by ESN IMEI</h5>
                                            <label>ESN:</label>
                                            <div class="input-group">
                                                <asp:TextBox ID="txtESN" runat="server" ToolTip="ESN List Number." />
                                    ...
                                    <asp:TabPanel ID="TabDIDMFromLocation" CssClass="tab-panel" runat="server" HeaderText="Location" ToolTip="Location">
                                        <ContentTemplate>
                                            <h5>Select by IFS location</h5>
                                            <label>Location:</label>
                                            <div class="input-group">
                                                <asp:TextBox ID="IFSMoveFromLocationOnly" runat="server" ToolTip="Location for which the Location number is updated." />
                                            	<div class="input-group-append">
                                    ...
                                    <asp:TabPanel ID="TabDIDMFromSite" CssClass="tab-panel" runat="server" HeaderText="Site" ToolTip="Site" Visible="true">
                                        <ContentTemplate>
                                    ...
                                    <asp:TabPanel ID="TabDIDMFromPaste" CssClass="tab-panel" runat="server" HeaderText="Paste" ToolTip="Paste">
                                        <ContentTemplate>
                                            <h5>Paste list</h5>
                                            <asp:RadioButtonList ID="PasteDeliminator" CssClass="radiolist-inline" runat="server" RepeatDirection="Horizontal">
                            ...
                            <div class="col-md">
                                <h3>To:</h3>
                                <asp:TabContainer CssClass="tab-container" ID="TabContainer2" runat="server">

                                    <asp:TabPanel ID="TabDIDMToLoc" CssClass="tab-panel" runat="server" HeaderText="To Loc" ToolTip="Set Device Location">
                                        <ContentTemplate>
                                            <h5>Move Device to New Location</h5>

                                            <div class="input-group">
                                                <asp:TextBox ID="txtLocation" runat="server" MaxLength="20" ToolTip="Location." />

                                            <div class="alert alert-info" role="alert">
                                                This utility will look for an IMEI version 000.
                                                It will then change the recorded location to this newly given location.
                                            </div>
                                            ...
                                            <asp:GridView ID="grdSearchSuggest" runat="server" AutoGenerateColumns="False" CssClass="table">
                                                <Columns>
                                    ...
                                    <asp:TabPanel ID="TabDIDMToSku" CssClass="tab-panel" runat="server" HeaderText="To SKU" ToolTip="Set Device SKU">
                                        <ContentTemplate>
                                            ...
                                            <div class="alert alert-warning" role="alert">
                                                ...
                                                <br>This will bulk set all IMEI records on the list to the settings below.
                                            </div>
                                            ...
                                            <asp:Label ID="lblDeviceToResku" runat="server" Text="" />
                                                ...
                                                <%--<label>Memory:</label>
                                                <asp:DropDownList ID="drpMemory" runat="server" AutoPostBack="True" />--%>

                                                <label>Colour:</label> 
                                                <asp:DropDownList ID="drpColour" runat="server" AutoPostBack="False" />

                                                <asp:Button ID="btnToSKU" CssClass="d-block" runat="server" Text="Go" />
                                    ...
                                    <asp:TabPanel ID="TabToBin" CssClass="tab-panel" runat="server" HeaderText="To Bin" ToolTip="Set Device Bin">
                                        <ContentTemplate>
                                            <h5>Change Device Bin</h5>
                                            <div class="input-group">
                                                <asp:TextBox ID="txtToBin" runat="server" />
                                            	<div class="input-group-append">
                                    ...
                                    <asp:TabPanel ID="TabToProductPlace" CssClass="tab-panel" runat="server" HeaderText="To Product Place" ToolTip="Set Device Product Place">
                                        <ContentTemplate>
                                            <h5>Change Device Product Place</h5>
                                            <div class="input-group">
                                                <asp:DropDownList ID="drpToProductPlace" runat="server" />
                                                <%--<asp:TextBox ID="txtToProductPlace" runat="server" />--%>
                                            	<div class="input-group-append">
                                                    <asp:Button ID="btnToProductPlace" runat="server" Text="Go" />
                                                </div>
                                            </div>
                                        </ContentTemplate>
                                    </asp:TabPanel>
                                    ...
                                    <asp:TabPanel ID="TabUnShipDevices" CssClass="tab-panel" runat="server" HeaderText="Unship" ToolTip="Unship devices">
                                        <ContentTemplate>
                                            ...
                                            <div class="alert alert-info" role="alert">
                                                This utility will look for an IMEI version 001 and reset that varsion back to 000.
                                                It will also remove data from Shipto, PSlip and Out-Bound Waybill-S attribute.
                                            </div>

                                            <asp:Button ID="btnUnShip" CssClass="d-block" runat="server" Text="Go" />
                                            
                                        </ContentTemplate>
                                    </asp:TabPanel>
                                    <asp:TabPanel ID="TabUnSwapDevices" CssClass="tab-panel" runat="server" HeaderText="Unswap" ToolTip="Unswap a device">
                                        <ContentTemplate>
                                            <h5>Unswap Device</h5>

                                            <div class="alert alert-info" role="alert">
                                                This utility will try to Unswap an IMEI.
                                                <ul>
                                                    <li>It will look for the IMEI version 000.</li>
                                                    <li>It will then look for the swap log record.</li>
                                                    <li>If they are found, It pulls the original IMEI from the swap log and resets the
                                                    device IMEI back to it original IMEI.</li>
                                                    <li>The Swap log record is then deleted.</li>
                                                    <li>It then looks for the -- Sacrificed -- device.</li>
                                                    <li>If that device is not found... all is ok, most likely an outside device.</li>
                                                    <li>If found, it resets the IMEI back to it's original.</li>
                                                    <li>It then deletes it's swap log record.</li>
                                                    <li>Everything should now be as it was before the swap.</li>
                                                </ul>
                                            </div>

                                            <asp:Button ID="btnUnSwap" CssClass="d-block" runat="server" Text="Go" />
                                                
                                        </ContentTemplate>
                                    </asp:TabPanel>
                                    <asp:TabPanel ID="TabToClientLocation" CssClass="tab-panel" runat="server" HeaderText="Client Location"
                                        ToolTip="Change the Client Location for the devices" Visible="False">
                                        <ContentTemplate>
                                            <h5>Change Device Client Location</h5>

                                            <asp:TextBox ID="txtNewClientLocation" runat="server" MaxLength="20"
                                                ToolTip="Client location scan code (eg:BW1)." />
                                            <asp:Button ID="btnNewClientLocation" CssClass="d-block" runat="server" Text="Go" />

                                            This utility will change the device current client location to a different client location.
                                        </ContentTemplate>
                                    </asp:TabPanel>
                                    <asp:TabPanel ID="tabDIDMGraveYard" CssClass="tab-panel" runat="server" HeaderText="GY" ToolTip="Grave yard the device.">
                                        <ContentTemplate>
                                            <h5>Grave yard the Devices.</h5>

                                            <asp:Button ID="btnGraveYard" CssClass="d-block" runat="server" Text="Go" />
<%--                                            <asp:Panel ID="Panel16" runat="server" Style="overflow: auto; max-height: 360px;
                                                ...
                                                <asp:DropDownList ID="drpIFSReasonCodesGYard" runat="server" BackColor="#A5EBC5"
                                                    ForeColor="Black" Font-Size="Larger" Visible="False">
                                                </asp:DropDownList>
                                                <br />
                                                <asp:Button ID="btnGraveYard" CssClass="d-block" runat="server" Text="Go" />
                                            </asp:Panel>--%>
                        ...
                        <asp:Label ID="lblMessageBTM" runat="server" Text=""></asp:Label>
