<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReceiveWaybill.aspx.cs" Inherits="BW_WebApp.ReceiveWaybill" %>
        ...
        <ContentTemplate>
            ...
            <div class="row">
            	<div class="col-md-6">
                    ...
                    <label>For Master Client:</label>
                    <asp:DropDownList ID="drpMasterClient" runat="server">
                    ...
                    <asp:HiddenField ID="lastWayBill" runat="server" Value="" />
...
<asp:Content ContentPlaceHolderID="js" runat="server">
    <script type="text/javascript">
        ...
        function RecordDetail() {
            ...
            service.SaveReceiveWayBill(esn, waybill, MasterClient, UserName(), OnAddSuccess, null, null);
        }
