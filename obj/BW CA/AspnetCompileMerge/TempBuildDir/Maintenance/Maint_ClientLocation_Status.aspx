<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Maint_ClientLocation_Status.aspx.cs" Inherits="BW_WebApp.Maintenance.Maint_ClientLocation_Status" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="pnlMainView" runat="server">
                ...
                <h1><asp:Label ID="lblRecordTitle" runat="server" Text="Maintenance Client Location Status" /></h1>
                ...
                <asp:Panel ID="pnlMainGrid" runat="server">
                    <asp:GridView ID="MainGrid" CssClass="table table-nonfluid" runat="server" AutoGenerateSelectButton="True" DataKeyNames="ClientLocationStatusID"
                        AutoGenerateColumns="False">
                        <Columns>
                            <asp:BoundField DataField="ClientLocationStatusID" HeaderText="ID" ReadOnly="True" Visible="false" />
            ...
            <asp:Panel ID="pnlAdd" CssClass="w-md-50" runat="server">
                <h1>Add Client Location Status</h1>
            ...
            <asp:Panel ID="pnlEdit" CssClass="w-md-50" runat="server">
                <h1>Edit Client Location Status</h1>
