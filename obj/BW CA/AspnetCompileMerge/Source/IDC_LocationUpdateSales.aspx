<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IDC_LocationUpdateSales.aspx.cs" Inherits="BW_WebApp.IDC_LocationUpdateSales" %>
...
<asp:Content ContentPlaceHolderID="cMC" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <h1>Inventory Distribution Sales</h1>
