<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BlackBelt.aspx.cs" Inherits="BW_WebApp.Maintenance.BlackBelt" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="pnlMainView" runat="server">
                <h1><asp:Label ID="lblRecordTitle" runat="server" Text="Blackbelt Dashboard" /></h1>
                <asp:TabContainer ID="TabContainer1" CssClass="tab-container" runat="server">
                    <asp:TabPanel ID="TabQuestion" CssClass="tab-panel" runat="server" HeaderText="Device">
                        <ContentTemplate>
                            <asp:Panel ID="Panel3" runat="server">
                                ...
                                <div>
                                <label>Status:</label>
                                <asp:DropDownList ID="DropDownHeaderStatus" CssClass="d-block w-md-50" runat="server" ToolTip="Status to look for" AutoPostBack="True" />
                                </div>

                                <asp:Button ID="btnAdd" runat="server" Text="Full Submit" OnClick="btnAdd_Click" />
...
<%--                                <asp:Button ID="btnPrintQuestion" runat="server" Text="Print Question" />
                            ...
                            <asp:Panel ID="pnlMainGrid" runat="server" Style="overflow: auto; max-height: 400px;">
                                <asp:GridView ID="MainGrid" CssClass="table" runat="server" AutoGenerateSelectButton="True" DataKeyNames="BlackbeltTransHeaderID" AutoGenerateColumns="False">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="BlackbeltTransHeaderID" HeaderText="ID" ReadOnly="True" Visible="false" />
                                        <asp:BoundField DataField="ESN" HeaderText="ESN">
                                            <ItemStyle Wrap="False" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="ProjectTag" HeaderText="ProjectTag" />
                                        <asp:BoundField DataField="ProjectName" HeaderText="ProjectName" />
                                        <asp:BoundField DataField="Message" HeaderText="Message" />
                                        <asp:BoundField DataField="ProcessStatus" HeaderText="ProcessStatus" />
                    ...
                    <asp:TabPanel ID="TabAnswer" CssClass="tab-panel" runat="server" HeaderText="Details">
                        <ContentTemplate>
                            <asp:Panel ID="pnlChild" runat="server" Visible="false">
                                <asp:Panel ID="Panel2" runat="server">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <h5><asp:Label ID="lblQuestionText" runat="server" Text="Detail" /></h5>
                                        </div>
                            ...
                            <asp:TabContainer ID="TabContainer2" CssClass="tab-container" runat="server">
                                <asp:TabPanel ID="TabPanel1" CssClass="tab-panel" runat="server" HeaderText="x">
                                    <ContentTemplate>
                                ...
                                <asp:TabPanel ID="TabMerge" CssClass="tab-panel" runat="server" HeaderText="y">
                                    <ContentTemplate>
