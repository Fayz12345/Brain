<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Dashboard.aspx.cs" Inherits="BW_WebApp.Dashboard" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ContentPlaceHolderID="HeadContent" runat="server"></asp:Content>
<asp:Content ContentPlaceHolderID="cMC" runat="server">
    <h1>Dashboard</h1>
    <asp:TabContainer runat="server" ID="t1x" CssClass="tab-container" ActiveTabIndex="1" > 
        ...
        <asp:TabPanel runat="server" ID="TabPanel1" CssClass="tab-panel" Enabled="true" HeaderText="Stats">
            <ContentTemplate>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <div>
                            <%--<label><asp:Label ID="lblLastupdated" runat="server" Text="Last Updated" ToolTip="Last Time Updated" /></label>--%>
                        ...
                        <asp:TabContainer ID="TabContainer1" CssClass="tab-container" runat="server">
                            <asp:TabPanel CssClass="tab-panel" runat="server" Enabled="true" HeaderText="Reporting Period">
                                <ContentTemplate>
                                    <%--<div>
