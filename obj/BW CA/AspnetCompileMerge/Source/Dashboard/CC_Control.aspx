<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CC_Control.aspx.cs" Inherits="BW_WebApp.CC_Control" %>
...
<%--            <asp:HiddenField ID="HdnSpreadQ" runat="server" ClientIDMode="Static" />
            ...
            <asp:TabContainer ID="TabContainer1" runat="server" CssClass="tab-container">
                <asp:TabPanel ID="TabPanelRuns" runat="server"  CssClass="tab-panel" HeaderText="Counts">
                    <ContentTemplate>
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <asp:TabContainer ID="TabRuns" runat="server" AutoPostBack="True" CssClass="tab-container">
                                    <asp:TabPanel ID="TabRunsNew" runat="server" HeaderText="New" CssClass="tab-panel">
                                        <ContentTemplate>
                                            <asp:Button ID="btnRefreshHeadersNew" runat="server" Text="Refresh" Width="100%" />
                                        </ContentTemplate>
                                    </asp:TabPanel>
                                    <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="Active" CssClass="tab-panel">
                                        <ContentTemplate>
                                            <asp:Button ID="btnRefreshHeadersNew0" runat="server" Text="Refresh" Width="100%" />
                                        </ContentTemplate>
                                    </asp:TabPanel>
                                    <asp:TabPanel ID="TabPanel13" runat="server" HeaderText="Hold" CssClass="tab-panel">
                                        <ContentTemplate>
                                            <asp:Button ID="btnRefreshHeadersNew1" runat="server" Text="Refresh" Width="100%" />
                                        </ContentTemplate>
                                    </asp:TabPanel>
                                    <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="SYNC Ready" CssClass="tab-panel">
                                        <ContentTemplate>
                                            <asp:Button ID="btnRefreshHeadersNew2" runat="server" Text="Refresh" Width="100%" />
                                        </ContentTemplate>
                                    </asp:TabPanel>
                                    <asp:TabPanel ID="TabInvalid" runat="server" HeaderText="Closed" CssClass="tab-panel">
                                        <ContentTemplate>
                                            <asp:Button ID="btnRefreshHeadersNew3" runat="server" Text="Refresh" Width="100%" />
                                        </ContentTemplate>
                                    </asp:TabPanel>
                                    <asp:TabPanel ID="TabOpen" runat="server" HeaderText="Invalid" CssClass="tab-panel">
                                        <ContentTemplate>
                                ...
                                <asp:Panel ID="pnlGridViewRunNew" runat="server" Style="width: auto;" HorizontalAlign="Left">
                                    ...
                                    <asp:Panel ID="pnlGridViewRunSpread" runat="server" Style="width: auto;" HorizontalAlign="Left"
                                        ...
                                        <asp:TabContainer ID="SpreadTabs" runat="server" AutoPostBack="True" CssClass="tab-container">
                                            <asp:TabPanel ID="SpreadTabActive" runat="server" HeaderText="Open" CssClass="tab-panel">
                                                <ContentTemplate>
                                                </ContentTemplate>
                                            </asp:TabPanel>
                                            <asp:TabPanel ID="SpreadTabHold" runat="server" HeaderText="Hold" CssClass="tab-panel">
                                                <ContentTemplate>
                                                </ContentTemplate>
                                            </asp:TabPanel>
                                            <asp:TabPanel ID="TabPanel5" runat="server" HeaderText="SYNC Ready" CssClass="tab-panel">
                                                <ContentTemplate>
                                                </ContentTemplate>
                                            </asp:TabPanel>
                                            <asp:TabPanel ID="SpreadTabClosed" runat="server" HeaderText="Closed" CssClass="tab-panel">
                                                <ContentTemplate>
                                                </ContentTemplate>
                                            </asp:TabPanel>
                                            <asp:TabPanel ID="SpreadTabInactive" runat="server" HeaderText="Invalid" CssClass="tab-panel">
                                                <ContentTemplate>
                                                </ContentTemplate>
                                            </asp:TabPanel>
                                            <asp:TabPanel ID="SpreadTabData" runat="server" HeaderText="Spread" CssClass="tab-panel">
                                                <ContentTemplate>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                    ...
                                                    <asp:Panel ID="Panel3" runat="server" Style="overflow: auto; max-height: 500px; width: auto;"
                                                        HorizontalAlign="Left" CssClass="tab-panel">
                                                        <asp:GridView ID="gvRunSpread" runat="server" Width="100%" DataKeyNames="CycleInventoryCountIterationHeaderID"
                                                            AutoGenerateColumns="False" CssClass="table" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                                    ItemStyle-Width="90px" ItemStyle-Wrap="False">
                                                                    <ItemTemplate>
<%--                                                                        <asp:ImageButton ID="imgDownloadSpreadSummary" runat="server" HeaderText="" ImageUrl="~/Images/arrow_down.png"
                                                                            ToolTip="Download Summary" Width="15px"></asp:ImageButton>
                                                                        <asp:ImageButton ID="imgDownloadSpreadSummaryDetail" runat="server" HeaderText=""
                                                                            ImageUrl="~/Images/arrow_down.png" ToolTip="Download Summary Detail" Width="15px">
                                                                        </asp:ImageButton>
                                                                        <asp:ImageButton ID="imgDownloadSpreadDetail" runat="server" HeaderText="" ImageUrl="~/Images/arrow_down.png"
                                                                            ToolTip="Download Detail" Width="15px"></asp:ImageButton>--%>
                                                                        <%--  <asp:ImageButton ID="imgOpenBatchList" runat="server" HeaderText="" ImageUrl="~/Images/closed.gif"
                                                                ToolTip="View/Activate Batches" Width="15px"></asp:ImageButton>--%>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:BoundField DataField="CycleInventoryCountHeaderID" HeaderText="Run #" HeaderStyle-HorizontalAlign="Left" ItemStyle-Wrap="False">
                                                                    <ItemStyle HorizontalAlign="left" VerticalAlign="Top" />
                                                                </asp:BoundField>
                                                                ...
                                                                <asp:BoundField DataField="DeviceCount" HeaderText="# Devices" HeaderStyle-HorizontalAlign="Left"
                                                                ...
                                                                <asp:BoundField DataField="IFSZoneLocationDevice" HeaderText="ZoneLocationDevice"
...
<%--                                                                <asp:BoundField DataField="IsLocationLocked" HeaderText="IsLocationLocked" HeaderStyle-HorizontalAlign="Left"
                                            ...
                                            <asp:TabPanel ID="TabPanel6" runat="server" HeaderText="Control" CssClass="tab-panel">
                                                <ContentTemplate>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                    ...
                                                    <asp:Panel ID="Panel6" runat="server" Style="overflow: auto; max-height: 500px; width: auto;"
                                                         HorizontalAlign="Left">
                                                        <asp:GridView ID="grdControl" runat="server" Width="100%" DataKeyNames="CycleInventoryCountControlDetailID"
                                                            AutoGenerateColumns="False" CssClass="table" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="ReceiveDetailID" HeaderText="RDID" HeaderStyle-HorizontalAlign="Left">
                                                                    <ItemStyle HorizontalAlign="left" VerticalAlign="Top" />
                                                                </asp:BoundField>
...
<%--                                                                <asp:BoundField DataField="ValueVariance" HeaderText="ValueVariance" HeaderStyle-HorizontalAlign="Left"
                                            ...
                                            <asp:TabPanel ID="TabScanResults" runat="server" HeaderText="Scan Results" CssClass="tab-panel">
                                                <ContentTemplate>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:RadioButtonList ID="ResultType" runat="server" RepeatDirection="Horizontal">
                                                                    ...
                                                                    <asp:ListItem Selected="False" Text="Summay SKU" Value="2"></asp:ListItem>
                                                    ...
                                                    <asp:Panel ID="Panel7" runat="server" Style="overflow: auto; max-height: 500px; width: auto;"
                                                        HorizontalAlign="Left">
                                                        <asp:GridView ID="grdResultData" runat="server" Width="100%" DataKeyNames="CycleInventoryCountControlDetailID"
                                                            AutoGenerateColumns="False" CssClass="table" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                                            AllowPaging="false" Font-Size="Smaller" AutoGenerateSelectButton="True" EnableViewState="False">
                                                            <SelectedRowStyle CssClass="srowstyle" />
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="CycleInventoryCountControlDetailID" HeaderText="C_ID" HeaderStyle-HorizontalAlign="Left">
                                                                    <ItemStyle HorizontalAlign="left" VerticalAlign="Top" />
                                                                </asp:BoundField>
                                                                ...
                                                                <asp:BoundField DataField="OKCondition" HeaderText="OKCondition" HeaderStyle-HorizontalAlign="Left">
                                                                    <ItemStyle HorizontalAlign="right" VerticalAlign="Top" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="IFSLocation" HeaderText="IFSLocation" HeaderStyle-HorizontalAlign="Left"
                                                                    ItemStyle-ForeColor="#009900">
                                                                ...
                                                                <asp:BoundField DataField="IMEI" HeaderText="IMEI" HeaderStyle-HorizontalAlign="Left"
                                                                    ItemStyle-ForeColor="#009900">
                                                                    <ItemStyle HorizontalAlign="left" VerticalAlign="Top" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Version" HeaderText="Version" HeaderStyle-HorizontalAlign="Left"
                ...
                <asp:TabPanel ID="TabTemplates" runat="server" HeaderText="Templates" CssClass="tab-panel">
                    <ContentTemplate>
                    <br />
                        <asp:TabContainer ID="TabContainer2" runat="server" Width="100%" CssClass="tab-container">
                            <asp:TabPanel ID="TabPanel3" runat="server" HeaderText="Active" CssClass="tab-panel">
                                <ContentTemplate>
                            ...
                            <asp:TabPanel ID="TabPanel4" runat="server" HeaderText="Inactive" CssClass="tab-panel">
                                <ContentTemplate>
                            ...
                            <asp:TabPanel ID="TabDIDMFromSite" runat="server" HeaderText="Add/Edit Template"
                                ToolTip="Add/Edit Template" CssClass="tab-panel">
                                <ContentTemplate>
                                    Select by site.<br />
                                    <br />
