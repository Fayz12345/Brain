<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RPT_Submission_02.aspx.cs" Inherits="BW_WebApp.RPT_Submission_02" %>
...
<br />
                    ...
                    <asp:TableRow>
                        <asp:TableCell HorizontalAlign="Left" ColumnSpan="3">
                            RMA Number:
                            <asp:Label ID="lblRMANumber" runat="server" Text=""></asp:Label>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell HorizontalAlign="Left" ColumnSpan="3">
                            Original IMEI:
                            <asp:Label ID="lblClientReferenceNumber" runat="server" Text=""></asp:Label>
                        </asp:TableCell>
                    </asp:TableRow>
