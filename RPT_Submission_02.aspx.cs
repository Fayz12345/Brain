...
namespace BW_WebApp
{
    public partial class RPT_Submission_02 : System.Web.UI.Page
    {
        ...
        public void LoadData(decimal ReceiveDetailID)
        {
            ...
            if (rd != null)
            {
                ...
                lblG10.Text = rdm.GetReceiveDetailItem_DataElement(rd.ReceiveDetailID, "EQU SAN");
                ...
                lblRMANumber.Text = rdm.GetReceiveDetailItem_DataElement(rd.ReceiveDetailID, "RMANumber");
                //lblActivationDate.Text = rdm.GetReceiveDetailItem_DataElement(rd.ReceiveDetailID, "Activation Date");
                lblClientReferenceNumber.Text = rdm.GetReceiveDetailItem_DataElement(rd.ReceiveDetailID, "Client Reference #");
